...
<dict>
    <!-- 
      Note for GitHub Contributors: 
      If you plan to distribute this app on the Mac App Store (MAS), you MUST enable the App Sandbox.
      Uncomment the following lines to enable sandboxing and required permissions.
      
      <key>com.apple.security.app-sandbox</key>
      <true/>
      
      Since we use KeyboardShortcuts (global hotkeys) and Apple Events (Focus Mode), you may also need:
      <key>com.apple.security.automation.apple-events</key>
      <true/>
      
      For MAS, Focus Mode via shortcuts might be restricted. Ensure you verify MAS guidelines.
    -->
</dict>
</plist>
PLIST
